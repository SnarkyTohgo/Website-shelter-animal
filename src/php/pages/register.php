...
<body>
  ...
  <div class="page">
    ...
    <div class="page-title">
      <div class="page-title-text">Sign up</div>
        ...
        <div class="range range-sm-center spacing-55">
          ...
          <div class="cell-sm-9 cell-md-7 cell-lg-6">
            <div class="inset-sm-25">
              <!-- Form-->
              <form id="signup-form" class="rd-mailform form-label-centered" method="post" action="../actions/action_signup.php">
                ...
                <button id="btn-signup" class="btn btn-tan-hide btn-block" type="submit">Sign up</button>
              </form>
            </div>
          </div>
        </div>
